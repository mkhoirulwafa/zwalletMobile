...
import TransactionHistoryChild from '../../../components/User/TransactionHistoryChild';
        ...
        <View style={styles2.wrapperTop}>
          <View style={styles2.fullFlex}>
            ...
            <View style={styles2.flexFour}>
              <Text style={styles2.semiBold}>Transaction History</Text>
            </View>
          </View>
        </View>
        <TransactionHistoryChild {...props} />
      </SafeAreaView>
    </>
  );
};
